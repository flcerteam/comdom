<div class="header">
  <div class="header-body">
    ...
    <a class="navbar-brand" href="{{route('trang-chu')}}">
      <img alt="Brand" src="source/image/YakiBBQ_Logo.jpg" >
    </a>
  </div>
  </div>
        ...
        <div class="container-fluid" style="background-image:url('source/image/wood.jpg')">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Thực Đơn<span class="caret"></span></a>
