  ...
  <div class="container-fluid" style="background-image:url('source/image/wood.jpg')">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <div class="beta-comp giohang navbar-right navbar-form">
          @if(Session::has('cart'))
          <div class="cart">
            <div class="beta-select"><i class="fa fa-shopping-cart"></i> <a style="color:#fff">Giỏ hàng ( <span id="tongso"> @if(Session::has('cart'))
              {{Session('cart')->totalQty}} </span> @else Trống @endif) </a><i class="fa fa-chevron-down"></i></div>
